...
# Metaloom AI Application 启动脚本
# Version: 1.0
# Author: metaloom-team

# 设置变量
APP_NAME="metaloom-ai"
...
start() {
    ...
    # 启动应用
    nohup $JAVA_CMD $JVM_OPTS -cp "$CLASSPATH" com.metaloom.ai.MetaloomAiApplication $APP_OPTS \
